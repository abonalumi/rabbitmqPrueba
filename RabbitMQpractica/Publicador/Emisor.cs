...
using(var connection = factory.CreateConnection())
{
    ...
    using(var canal = connection.CreateModel())
    {
        ...
        canal.QueueDeclare(queue: "Saludo", durable: false, exclusive: false, autoDelete: false, arguments: null);
        // se crea un mensaje
        string mensaje = "Hola conejo!";
        // se codifica el mensaje a bytes
        var cuerpo = Encoding.UTF8.GetBytes(mensaje);
        // se envía el mensaje
        canal.BasicPublish(exchange: "", routingKey: "Saludo", basicProperties: null, body: cuerpo);
